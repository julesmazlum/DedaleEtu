...
import eu.su.mas.dedaleEtu.mas.myBehaviours.Explore.MyExploreFSMBehaviour;
import jade.core.behaviours.Behaviour;
import java.util.HashMap;


public class MyExploreAgent extends AbstractDedaleAgent {
	...
	protected void setup(){
		...
		lb.add(new MyExploreFSMBehaviour(this));
